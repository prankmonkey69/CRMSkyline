                                ...
                                <br>
                                 <div class="row">
                                    <div class="col">
                                        ...
                                        <p><strong>Number of Days: </strong><i style="color:blue"></i><?php echo $inf['no_of_days'];?> Days</p>
                                    ...
                                    <div class="col">
                                        ...
                                        <p><strong>Total: </strong><i style="color:blue"></i><?php echo $inf['promorate']*$inf['no_of_room']*$inf['no_of_days'];?> Php</p> 
                                </div>
                                </div>  <br>
                                <?php }?>
                                </div>
